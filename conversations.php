    ...
    <body>
        ...
        <div>
            ...
            if(isset($_GET['hash']) && !empty($_GET['hash'])){
                $hash = $_GET['hash'];
                $message_query = mysql_query("select from_id, message from msg where group_hash = '$hash'" );
            ...
            <form method='post'>
                ...
                if(isset($_POST['message']) && !empty($_POST['message'])){
                    $new_message = $_POST['message'];   
                     mysql_query("Insert into msg values('','$hash','$my_id','$new_message' )");
            ...
            <?php    
                ...
                $get_con = mysql_query("Select hash, user1 , user2 from msg_group WHERE user1 = '$my_id' OR user2 = '$my_id'");
